...
\todo{make up some kind of syntax highlighting? }
...
Because Qwire's linear type system prevents us from using a wire value twice, this is fine\ls{very weaselly worded}.
...
Unitary gates can be inverted or controlled, producing new unitary gates.\ls{previous sentence not great}
...
\begin{figure}
    \todo{find better way to format this}
\begin{align*}
